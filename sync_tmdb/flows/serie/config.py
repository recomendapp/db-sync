...
class SerieConfig(Config):
	def __init__(self, date: date):
		...
		# Columns
		self.serie_columns: list[str] = ["id", "adult", "in_production", "original_language", "original_name", "popularity", "status", "type", "vote_average", "vote_count", "number_of_episodes", "number_of_seasons", "first_air_date", "last_air_date", "updated_at"]
